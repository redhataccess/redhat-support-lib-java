...
public class Articles extends BaseQuery {
	...
	public ArticleType get(String artID) throws RequestException, MalformedURLException {
		...
		return get(connectionManager.getConnection(), fullUrl, ArticleType.class);
	}
	...
	public List<ArticleType> list(String[] keywords, String[] kwargs)
		...
		String fullUrl = QueryBuilder.appendQuery(connectionManager.getConfig().getUrl()
						+ url, queryParams);
		com.redhat.gss.redhat_support_lib.parsers.ArticlesType articlesType = get(connectionManager.getConnection(), fullUrl,
